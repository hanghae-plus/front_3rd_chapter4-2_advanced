...
import { useScheduleContext } from "../basic/ScheduleContext.tsx";
import { Lecture } from "../basic/types.ts";
import { parseSchedule } from "../basic/utils.ts";
import { DAY_LABELS } from "../basic/constants.ts";
