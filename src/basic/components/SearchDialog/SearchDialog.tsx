...
const createFetchCache = () => {
  const cache: Record<string, unknown> = {};

  return function <T>(key: string, fetchFunction: FetchFunction<T>) {
    if (cache[key]) {
...
const fetchMajors = () =>
    fetchCache<AxiosResponse<Lecture[]>>('majors', () => axios.get('/schedules-majors.json'));
const fetchLiberalArts = () =>
    fetchCache<AxiosResponse<Lecture[]>>('liberalArts', () =>
        axios.get('/schedules-liberal-arts.json'),
    );
