...
function createCache<T>() {
	const cache: Record<string, Promise<AxiosResponse<T>>> = {};
...
const fetchSchedulesCache = createCache<Lecture[]>();

const cachedFetchMajors = fetchSchedulesCache("majors", fetchMajors);

const cachedFetchLiberalArts = fetchSchedulesCache("arts", fetchLiberalArts);
